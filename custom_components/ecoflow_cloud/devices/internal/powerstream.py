...
class PowerStream(BaseDevice):
    def sensors(self, client: EcoflowApiClient) -> list[BaseSensorEntity]:
        return [
            ...
            DecivoltSensorEntity(
                client, self, "pv1_input_volt", "Solar 1 Input Potential"
            ),
            ...
            MiscSensorEntity(
                client, self, "pv1_error_code", "Solar 1 Error Code", False
            ),
            MiscSensorEntity(
                client, self, "pv1_warning_code", "Solar 1 Warning Code", False
            ),
            ...
            DecivoltSensorEntity(
                client, self, "pv2_input_volt", "Solar 2 Input Potential"
            ),
            ...
            MiscSensorEntity(
                client, self, "pv2_error_code", "Solar 2 Error Code", False
            ),
            MiscSensorEntity(
                client, self, "pv2_warning_code", "Solar 2 Warning Code", False
            ),
            ...
            DeciwattsSensorEntity(
                client, self, "bat_input_watts", "Battery Input Watts"
            ),
            DecivoltSensorEntity(
                client, self, "bat_input_volt", "Battery Input Potential"
            ),
            DecivoltSensorEntity(client, self, "bat_op_volt", "Battery Op Potential"),
            MilliampSensorEntity(
                client, self, "bat_input_cur", "Battery Input Current"
            ),
            ...
            RemainSensorEntity(
                client, self, "battery_discharge_remain", "Discharge Time"
            ),
            MiscSensorEntity(
                client, self, "bat_error_code", "Battery Error Code", False
            ),
            MiscSensorEntity(
                client, self, "bat_warning_code", "Battery Warning Code", False
            ),
            MiscSensorEntity(client, self, "bat_status", "Battery Status", False),
            DecivoltSensorEntity(
                client, self, "llc_input_volt", "LLC Input Potential", False
            ),
            DecivoltSensorEntity(
                client, self, "llc_op_volt", "LLC Op Potential", False
            ),
            MiscSensorEntity(client, self, "llc_error_code", "LLC Error Code", False),
            MiscSensorEntity(
                client, self, "llc_warning_code", "LLC Warning Code", False
            ),
            MiscSensorEntity(client, self, "llc_status", "LLC Status", False),
            MiscSensorEntity(client, self, "inv_on_off", "Inverter On/Off Status"),
            DeciwattsSensorEntity(
                client, self, "inv_output_watts", "Inverter Output Watts"
            ),
            DecivoltSensorEntity(
                client, self, "inv_input_volt", "Inverter Output Potential", False
            ),
            DecivoltSensorEntity(client, self, "inv_op_volt", "Inverter Op Potential"),
            MilliampSensorEntity(
                client, self, "inv_output_cur", "Inverter Output Current"
            ),
            ...
            MiscSensorEntity(
                client, self, "inv_error_code", "Inverter Error Code", False
            ),
            MiscSensorEntity(
                client, self, "inv_warning_code", "Inverter Warning Code", False
            ),
            ...
            MiscSensorEntity(
                client, self, "wireless_error_code", "Wireless Error Code", False
            ),
            MiscSensorEntity(
                client, self, "wireless_warning_code", "Wireless Warning Code", False
            ),
            MiscSensorEntity(client, self, "inv_brightness", "LED Brightness", False),
            MiscSensorEntity(
                client, self, "heartbeat_frequency", "Heartbeat Frequency", False
            ),
